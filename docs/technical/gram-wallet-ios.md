...
- [ ] Add Gram universal link domains `connect.gramwallet.io` and `go.gramwallet.io` and update server-side AASA files.
...
- [x] Route Gram TonConnect universal links through `https://connect.gramwallet.io` in native parser and Air SDK deeplink handling.
