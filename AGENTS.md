...
- Keep this block lean. If the workflow needs more Codex guidance, prefer nested `AGENTS.md` or `AGENTS.override.md` files instead of expanding this root block indefinitely.
