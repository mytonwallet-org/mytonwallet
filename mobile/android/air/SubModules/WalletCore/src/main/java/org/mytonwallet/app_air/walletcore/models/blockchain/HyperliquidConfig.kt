...
object HyperliquidConfig : MBlockchainConfig {
    ...
    override val displayColor = "#00AF98".hexToColorInt()
    override val qrGradientColors = intArrayOf(
        "#4B6563".hexToColorInt(),
        "#24534B".hexToColorInt()
    )
    ...
    override val walletConnectChainIds = mapOf(
        MBlockchainNetwork.MAINNET to 999,
        MBlockchainNetwork.TESTNET to 998
    )
    ...
    override fun transactionExplorers() = listOf(MBlockchainExplorer.HYPEREVMSCAN)

    override fun addressExplorers() = listOf(MBlockchainExplorer.HYPEREVMSCAN)

    override fun tokenExplorer() = MBlockchainExplorer.HYPEREVMSCAN
