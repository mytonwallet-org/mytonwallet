...
class WRippleDrawable private constructor(
    ...
    companion object {
        fun create(cornerRadius: Float): WRippleDrawable =
            create(cornerRadius, cornerRadius, cornerRadius, cornerRadius)

        fun create(drawable: Drawable, cornerRadius: Float): WRippleDrawable =
            create(drawable, cornerRadius, cornerRadius, cornerRadius, cornerRadius)

        fun create(drawable: Drawable): WRippleDrawable =
            WRippleDrawable(0, drawable, ShapeDrawable(RectShape()))
        ...
        fun create(
            ...
            rLeftBottom: Float,
            rRightBottom: Float
        ): WRippleDrawable = create(null, rLeftTop, rRightTop, rLeftBottom, rRightBottom)
        ...
        fun create(
            ...
            rLeftBottom: Float,
            rRightBottom: Float
        ): WRippleDrawable = if (rLeftTop == 0f && rRightTop == 0f && rLeftBottom == 0f &&
            rRightBottom == 0f
        ) {
