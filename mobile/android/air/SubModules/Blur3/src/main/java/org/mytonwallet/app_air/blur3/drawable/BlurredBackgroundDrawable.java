package org.mytonwallet.app_air.blur3.drawable;
...
import org.mytonwallet.app_air.blur3.source.BlurredBackgroundSourceWrapped;
import org.mytonwallet.app_air.blur3.utils.NinePatchBuilder;
...
public abstract class BlurredBackgroundDrawable extends Drawable {
    ...
    private void drawSourceAny(Canvas canvas, BlurredBackgroundSource source) {
        ...
        final int backgroundColor = Blur3Colors.multAlpha(this.backgroundColor, alpha / 255f);
        if (Color.alpha(shadowColor) > 0 && alpha == 255 && shadowAlpha > 0) {
            shadowPaint.setShadowLayer(shadowLayerRadius, shadowLayerDx, shadowLayerDy, Blur3Colors.multAlpha(shadowColor, shadowAlpha));
    ...
    private void drawStrokeInternalIfNeeded(Canvas canvas) {
        final int strokeColorTop = Blur3Colors.multAlpha(this.strokeColorTop, alpha / 255f);
        final int strokeColorBottom = Blur3Colors.multAlpha(this.strokeColorBottom, alpha / 255f);
