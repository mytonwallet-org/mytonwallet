...
public class BlurredBackgroundProviderBuilder implements BlurredBackgroundProvider {
    ...
    public BlurredBackgroundProviderBuilder(Blur3Theme.ResourcesProvider resourcesProvider) {
    ...
    public interface ColorProvider {
        int getColor(Blur3Theme.ResourcesProvider resourcesProvider, boolean isDark);
    }
    ...
    private boolean isDark() {
        return resourcesProvider != null ? resourcesProvider.isDark() : Blur3Theme.isCurrentThemeDark();
    }
