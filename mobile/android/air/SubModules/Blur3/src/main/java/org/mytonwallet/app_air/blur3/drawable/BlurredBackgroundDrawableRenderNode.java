...
import static org.mytonwallet.app_air.blur3.compat.Blur3Dp.dp;
...
import org.mytonwallet.app_air.blur3.LiquidGlassEffect;
...
public class BlurredBackgroundDrawableRenderNode extends BlurredBackgroundDrawable {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        int color = Blur3Colors.multAlpha(shadowColor, renderNode.getAlpha() * shadowAlpha);
    ...
    public void setAlpha(int alpha) {
        ...
        // The content is a stack of overlapping draws (under color, blur, strokes); a translucent
        // node must fade them as one composited layer or the under color bleeds through.
        renderNode.setUseCompositingLayer(alpha < 255, null);
        renderNodeInvalidated = true;
