...
public class StrokeDrawable extends Drawable {
    ...
    public void updateColors() {
        ...
        strokeColorTop = Blur3Colors.multAlpha(colorProvider.getStrokeColorTop(), alpha);
        strokeColorBottom = Blur3Colors.multAlpha(colorProvider.getStrokeColorBottom(), alpha);
