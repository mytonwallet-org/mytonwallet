...
open class AssetsPlaceholderCell: UITableViewCell {
    ...
    private lazy var makeWalletTokenSkeletonView: () -> UIView = {
        ...
        iconSkeleton.backgroundColor = .air.groupedBackground
        ...
        tokenNameSkeleton.backgroundColor = .air.groupedBackground
        ...
        tokenPriceSkeleton.backgroundColor = .air.groupedBackground
        ...
        amountSkeleton.backgroundColor = .air.groupedBackground
        ...
        baseCurrencyAmountSkeleton.backgroundColor = .air.groupedBackground
    ...
    private func updateTheme() {
        innerView.backgroundColor = .air.groupedItem
    }
}
