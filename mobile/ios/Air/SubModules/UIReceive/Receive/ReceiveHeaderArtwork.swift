...
private extension ApiChain {
    var receiveHeaderPalette: ReceiveHeaderPalette {
        ...
        case .bitcoin:
            ReceiveHeaderPalette([
                figmaColor(1, 0.8274509803921568, 0.4588235294117647),
                figmaColor(1, 0.5294117647058824, 0.19215686274509805),
                figmaColor(1, 0.7294117647058823, 0.3215686274509804),
                figmaColor(1, 0.5294117647058824, 0.19215686274509805),
            ])
        case .litecoin:
            ReceiveHeaderPalette([
                figmaColor(0.7215686274509804, 0.9019607843137255, 1),
                figmaColor(0.20392156862745098, 0.36470588235294116, 0.615686274509804),
                figmaColor(0.5607843137254902, 0.8156862745098039, 1),
                figmaColor(0.20392156862745098, 0.36470588235294116, 0.615686274509804),
            ])
        case .bitcoincash:
            ReceiveHeaderPalette([
                figmaColor(0.7137254901960784, 0.984313725490196, 0.9098039215686274),
                figmaColor(0.0392156862745098, 0.7568627450980392, 0.5568627450980392),
                figmaColor(0.5764705882352941, 1, 0.6),
                figmaColor(0.0392156862745098, 0.7568627450980392, 0.5568627450980392),
            ])
        case .dogecoin:
            ReceiveHeaderPalette([
                figmaColor(0.9568627450980393, 0.9254901960784314, 0.7058823529411765),
                figmaColor(0.596078431372549, 0.5176470588235295, 0.18823529411764706),
                figmaColor(1, 0.8705882352941177, 0.42745098039215684),
                figmaColor(0.596078431372549, 0.5176470588235295, 0.18823529411764706),
            ])
        case .ethereum:
            ReceiveHeaderPalette([
       ...
       case .avalanche:
        ...
        case .arc:
            ReceiveHeaderPalette([
                figmaColor(0.6470588235294118, 0.7843137254901961, 0.9254901960784314),
                figmaColor(0.07058823529411765, 0.1607843137254902, 0.2901960784313726),
                figmaColor(0.15294117647058825, 0.4588235294117647, 0.792156862745098),
                figmaColor(0.07058823529411765, 0.1607843137254902, 0.2901960784313726),
            ])
        case .other:
            ReceiveHeaderPalette([
