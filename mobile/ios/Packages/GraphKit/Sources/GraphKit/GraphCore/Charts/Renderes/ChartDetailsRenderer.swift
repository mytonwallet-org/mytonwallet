...
class ChartDetailsRenderer: BaseChartRenderer, ChartThemeContainer {
    ...
    override func render(context: CGContext, bounds: CGRect, chartFrame: CGRect) {
        ...
        let textNode = TextRenderer.layoutText(attributedString, bounds.size)
        ...
        for (index, row) in widths.enumerated() {
            ...
            var textNode = TextRenderer.layoutText(attributedString, bounds.size)
            ...
            textNode = TextRenderer.layoutText(attributedString, bounds.size)
