import { ACTIVE_TAB_STORAGE_KEY, IS_EXPLORER, IS_TELEGRAM_APP } from '../config';
import {
  IS_DELEGATED_BOTTOM_SHEET, IS_ELECTRON, IS_LEDGER_EXTENSION_TAB,
} from './windowEnvironment';

const IS_DISABLED = (
  IS_LEDGER_EXTENSION_TAB || IS_DELEGATED_BOTTOM_SHEET || IS_ELECTRON || IS_TELEGRAM_APP || IS_EXPLORER
);
